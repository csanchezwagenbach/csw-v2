...
export default function Bio() {
    return (
        <div className="container-fluid my-1">
            <div className="row mb-1 mt-3 me-1 ms-1 justify-content-between">
                <h6 className="col-6 design-journey me-3"><em>My design journey began at sixteen, in the drawing studio.
                    ...
                    <img src={avatar} className='img-fluid  greyed col-5 px-0' alt='Avatar photo at Paterson Falls'></img>
            </div>
            
            <br></br>
            <h8 className="text-start">
                Since those sophomoric days in the studio, a number of experiences moulded both my professional ambition and aesthetic development. I spent three years appearing on stage with a <a href='https://www.shakespeareonthelawn.org/' className="link">student theater group</a> while studying in Charlottesville. I graduated in 2016, and after some time spent <a href='https://www.peoplesworld.org/authors/colby-wagenbach/'className="link">publishing online</a> , I landed in Washington, D.C., where I spent the next two years working at an <a href='https://www.kramers.com/'className="link">independent bookstore</a> , <a href='https://www.zekescoffeedc.com/'className="link">selling coffee</a> at Farmer's Markets around the District, conducting private tours throughout the capital's galleries, and taking up the study of French at the local <a href='https://www.francedc.org/index'className="link">Alliance Francaise:</a> A time both productive and marvelous.
                <br></br>
                <br></br>
                I moved to New York City and began work as an educator in the Bedford-Stuyvesant section of Brooklyn. Math literacy as theorized and practiced by Bob Moses and <a href='https://algebra.org/wp/'className="link">The Algebra Project</a> , (<a href='https://www.afriwarebooks.com/store/p2793/RADICAL-EQUATIONS-CIVIL-RIGHTS-MISSISSIPPI-ALGEBRA-PROJECT-ROBERT-MOSES-9780807031278.html'className="link">Radical Equations</a> is a must-read for any mathematician) became an obsession. This drive, along with the pressing demands of the pandemic, challenged my students and I to integrate technology into all aspects of our learning, to see parallels abound between human cognition and technological exercises. I piloted the integration of <a href='https://freckle.com/en-us/'className="link">an online learning platform</a> to supplement the curriculum, and I'm proud to say my first experience writing code was the <a href='https://codehs.com/course/719/overview'className="link">Intro to Programming with Karel the Dog.</a>
                <br></br>
                <br></br>
